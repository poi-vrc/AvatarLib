...
namespace Chocopoi.AvatarLib.Tests
{
    ...
    {
        public const string GeneratedAssetsFolderName = "_ALGeneratedAssets";
        ...
        protected T LoadEditorTestAsset<T>(string relativePath) where T : Object
        {
            ...
            var path = "Packages/com.chocopoi.vrc.avatarlib/Tests/Editor/Resources/" + GetType().Name + "/" + relativePath;
